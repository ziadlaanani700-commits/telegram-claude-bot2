...
async def handle_message(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Tu es un assistant IA intelligent, bienveillant et précis. Tu réponds en français sauf si on te parle dans une autre langue. Sois concis et utile."},
